...
class ReportRotationTest {
    ...
    void retainsEachFormatAndIgnoresStableLatestPointers() throws Exception {
        ...
        Files.writeString(directory.resolve("00000000-0000-0000-0000-000000000001.md"), "1");
        Files.writeString(directory.resolve("00000000-0000-0000-0000-000000000002.md"), "2");
